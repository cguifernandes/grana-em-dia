	...
	return (
		<Card className="gap-6 p-4">
			<CardHeader className="px-0">
				...
				<CardDescription>
					Acompanhe a diferença nos seus gastos em cada categoria em relação ao
					mês anterior.
				</CardDescription>
			</CardHeader>
			...
			<CardContent className="px-0">
				{data && data.length > 0 ? (
							...
							>
								<div
									className={cn(
										...
										variation.positive ? "bg-primary/20" : "bg-destructive/20"
									)}
								>
									{variation.positive ? (
								...
								<div className="flex flex-col gap-y-1">
									...
									<p
										className={cn(
											...
											variation.positive ? "text-primary" : "text-destructive"
										)}
									>
					...
					<p className="text-sm text-center">Sem variações por categoria</p>
				)}
			</CardContent>
