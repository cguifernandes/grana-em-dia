...
import ExpensesByCategoryChartInteractive from "@/components/charts/expenses-by-category-chart-interactive";
			...
			<DashboardLayout title="Relatórios">
				<div className="h-full flex flex-col gap-y-4">
					...
					<Tabs defaultValue={defaultTab}>
						...
						<TabsContent value="monthly" className="flex flex-col gap-y-2">
							<div className="flex gap-x-2">
								...
								/>
								<BalanceCard
									icon={<ShoppingCart className="text-indigo-500" size={16} />}
									title="Maior despesa"
									className="flex-1"
									text="Moradia"
								...
								/>
								<BalanceCard
									icon={<PiggyBank className="text-lime-500" size={16} />}
						...
						<TabsContent value="categories" className="flex flex-col gap-y-2">
							<ExpensesByCategoryChartInteractive
								className="flex-1"
						...
						<TabsContent value="transactions">
							<TransactionList showAll transactions={mockTransactions} />
						</TabsContent>
					</Tabs>
				</div>
			</DashboardLayout>
